...
# New Constants for Additional Inputs UI
VALUES_LOAD_CASE = ["Dead Load (DL)", "Super-imposed Dead Load (SIDL)", "Dead Load of Wearing Course (DW)"]
VALUES_DECKING_PLATE = ["None", "Type A", "Type B"]
VALUES_NO_OF_LANES = ["1", "2", "3", "4", "5", "6"]
